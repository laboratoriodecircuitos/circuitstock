...
A pasta possui o layout visual inicial, dashboard lendo estatisticas reais do banco local e paginas placeholder. CRUD, formularios e fluxos completos serao implementados em etapas futuras.
